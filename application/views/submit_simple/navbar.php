    ...
    <div class="dbl-blk clear">
        <div class="left_blk">
            <div class="logos clear">
                <div class="img">
                    <img src="<?= base_url() ?>assets/submit_simple/images/ku-logo.png" style="width: 173px;" alt="">
                </div>
                <div class="img">
                    <img src="<?= base_url() ?>assets/submit_simple/images/health-logo.png" style="width: 197px;" alt="">
                </div>
            </div>
        </div>
        <div class="right_blk">
