    ...
    <div class="wrapper content">
        <form method="POST" action="" id="submission-form">
            <div class="field single">
                ...
                <input type="text" name="emiratesid" id="emiratesid" value="<?= $user_entered_id->emirates_id ?>" pattern="^[a-zA-Z0-9]+$" required autocomplete="off" />
            </div>

            <div class="field single">
                <label for="ku_id">KU ID : <span>(Format: 1000XXXXX)</span> <span class="required">*</span></label>
                <input type="text" class="ku_id" name="ku_id" id="ku_id" value="<?= $user_entered_id->ku_id ?>" pattern="^[0-9]+$" required autocomplete="off">
            </div>
            ...
            <div class="upload-blk clear">
                ...
                <div class="upload clear">
                    ...
                    <input type="file" class="input-file" name="emirates_id_file" id="emirates_id_file" required accept="application/pdf,.pdf">
                    <br><br>
                </div>
                <p class="emirates_id_uploaded_file"></p>
            </div>

            <div class="field triple clear">
                <div class="blk clear">
                    <label for="first_name">First name: <span class="required">*</span></label><br><br>
                    <input type="text" class="first_name" id="first_name" name="first_name" required autocomplete="off">
                </div>
                <div class="blk clear">
                    ...
                    <input type="text" class="middle_name" id="middle_name" name="middle_name" required autocomplete="off">
                </div>
                <div class="blk clear">
                    <label for="last_name">Last name: <span class="required">*</span></label><br><br>
                    <input type="text" class="last_name" id="last_name" name="last_name" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="field insert clear">
                ...
                <div class="drop-blk">
                    <div class="img-upload">
                        ...
                        <input type="file" class="photo" id="photo" name="profile_photo" accept="image/jpg, image/png, image/gif, image/jpeg" required>
            ...
            <div class="field double clear">
                <div class="blk clear">
                    ...
                    <input type="text" name="d_year" class="d_year" required autocomplete="off" readonly>
                </div>
                <div class="blk clear">
                    <label for="mobile">Mobile: <span class="required">*</span></label>
                    <input type="text" name="mobile" class="mobile" id="mobile" required autocomplete="off">
                    <!-- <input type="hidden" name="real_phone" class="real_phone" id="real_phone" autocomplete="off"> -->
                </div>
            </div>
            ...
            <div class="field double clear">
                <div class="blk clear">
                    ...
                    <input type="email" name="personal_email" class="p_email" id="personal_email" required autocomplete="off">
                </div>
                <div class="blk clear">
                    <label for="country">Country of Residence : <span class="required">*</span></label>
                    <input type="text" class="country" name="country" id="country" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="field double clear">
                <div class="blk clear">
                    ...
                    <input type="text" class="nationality" name="nationality" id="nationality" required autocomplete="off">
                </div>
                <div class="blk clear">
                    ...
                    <input type="text" class="linkedin" name="linkd_in" id="linkd_in" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="field check clear">
                ...
                <div class="blk blk_multiple clear">
                    ...
                    <div class="clear">
                        <div class="checkbox">
                            <input type="radio" data-id="1" value="Employed and satisfied" id="eas" name="e_status" required checked />
                            <label for="eas"></label>
                        </div>
                        <label class="label" for="eas">Employed and satisfied</label>
                    </div>

                    <div id="check_sub" class="emp_1 clear" style="display: block">
                        ...
                        <div class="sub_single clear">
                            ...
                            <input type="text" class="c_name" name="c_name" required>
                        </div>

                        <div class="sub_single clear">
                            <label for="j_title">Job Title : <span class="required">*</span></label>
                            <input type="text" class="j_title" name="j_title" required>
                        </div>

                        <div class="sub_single clear">
                            <label for="w_email">Your work email (optional)</label>
                            <input type="email" class="w_email" name="w_email">
                        </div>
                        ...
                        <?php if ('show' != 'show') { ?>
                            <div class="sub_button clear">
                                ...
                                <div class="sub_options clear">
                                    <div><input class="hidden radio-label" type="radio" name="work-study-1" id="work-yes-button" checked="checked" value="Yes" required /><label class="button-label" for="work-yes-button">
                                            <h1>Yes</h1>
                                        </label><input class="hidden radio-label" type="radio" name="work-study-1" id="work-no-button" value="No" required /><label class="button-label" for="work-no-button">
                                            <h1>No</h1>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="sub_single clear">
                            ...
                            <input type="text" class="sector" name="sector" required>
                        </div>
                            ...
                            <div class="sub_options clear">
                                <div>
                                    ...
                                    foreach ($type_emp_1 as $job) {
                                        ...
                                        <input class="hidden radio-label" type="radio" name="type-sec-1" id="full-button-1-<?= $k ?>" <?= $checked ?> value="<?= $job ?>" required /><label class="button-label" for="full-button-1-<?= $k ?>">
                                            <h1><?= $job ?></h1>
                                        </label>
                                    <?php $k++;
                                    } ?>
                                ...
                                <div class="sub_single clear">
                                    <input type="text" class="others other_type_1" name="other_type_1" placeholder="Enter other type" <?= $other_none ?> disabled style="display: none;" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sub_button clear">
                            ...
                            <div class="sub_options clear">
                                <div><input class="hidden radio-label" type="radio" name="business-1" id="relevant-yes-button" checked="checked" <?= $first_check_selfe ?> value="Yes" required /><label class="button-label" for="relevant-yes-button">
                                        <h1>Yes</h1>
                                    </label><input class="hidden radio-label" type="radio" name="business-1" id="relevant-no-button" value="No" required /><label class="button-label" for="relevant-no-button">
                                        <h1>No</h1>
                                    </label><input class="hidden radio-label" type="radio" name="business-1" id="relevant-NotSure-button" value="Not sure" required /><label class="button-label" for="relevant-NotSure-button">
                                        <h1>Not Sure</h1>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div id="check_sub" class="emp_2 clear" <?= ($registered_data && $registered_data->e_status == 'Employed, but unsatisfied') ? 'style="display: block";' : ''; ?>>
                        ...
                        <div class="sub_button clear">
                            ...
                            <div class="sub_options clear">
                                ...
                                <div class="sub_single clear">
                                    <input type="text" class="others other_type_2" name="other_type_2" placeholder="Enter other type" <?= $other_none ?> disabled required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sub_button clear">
                            <label>Would you say the specialization you studied at KU is relevant to your business? : <span class="required">*</span></label>
                            <div class="sub_options clear">
                                <div><input class="hidden radio-label" type="radio" name="business-2" id="business-2-1" <?= $first_check_selfer ?> value="Yes" disabled required /><label class="button-label" for="business-2-1">
                                        <h1>Yes</h1>
                ...
                <div class="blk blk_multiple clear">
                    ...
                    <div id="check_sub" class="emp_3 clear" <?= ($registered_data && $registered_data->e_status == 'Self-Employed') ? 'style="display: block";' : ''; ?>>
                        ...
                        <div class="sub_button clear">
                            <label>Would you say the specialization you studied at KU is relevant to your business? : <span class="required">*</span></label>
                            <div class="sub_options clear">
                                <div><input class="hidden radio-label" type="radio" name="special-3" id="special-3-1" <?= $first_check_self ?> value="Yes" disabled required /><label class="button-label" for="special-3-1">
                                        <h1>Yes</h1>
                ...
                <div class="blk blk_multiple clear">
                    ...
                    <div id="check_sub" class="emp_4 clear">
                        <div class="sub_button clear">
                            ...
                            <div class="sub_options clear">
                                <div><input class="hidden radio-label" type="radio" name="preference-4" id="preference-4-1" <?= $first_check ?> value="Private" disabled required /><label class="button-label" for="preference-4-1">
                                        <h1>Private</h1>
                        ...
                        <div class="sub_button clear">
                            ...
                            <div class="sub_options clear">
                                ...
                                <div class="sub_single clear">
                                    <input type="text" class="others other_type_4" name="other_type_4" placeholder="Enter other type" <?= $other_none ?> disabled required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sub_button clear">
                            ...
                            <div class="sub_options clear">
                                ...
                                <div>
                                    ...
                                    ?>
                                        <input class="hidden radio-label" type="radio" name="looking-job-5" id="looking-job-5-<?= $i ?>" value="<?= $look_job ?>" disabled required /><label class="button-label" for="looking-job-5-<?= $i ?>">
                                            <h1><?= $look_job ?></h1>
                                        </label>
                                    <?php $i++;
                                    } ?>
                                ...
                                <div class="sub_single clear">
                                    <input type="text" class="others other_look_job" placeholder="Enter other reason" name="other_look_job" <?= $other_none ?> disabled required>
                                </div>
                            </div>
                        </div>
