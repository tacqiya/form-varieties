...
<head>
    <title>Alumni Card Dashboard</title>
    <meta charset="utf-8">
...
<body>
    <div class="wrap">
        <div class="navbare">
            <div class="dropdowne">
                <button class="dropbtne">Admin
                    <i class="fa fa-caret-down"></i>
                </button>
                <div class="dropdown-contente">
                    <a class="export-a" href="<?= base_url('export-registrants') ?>">Export Registrant Data</a>
                    <a class="export-a" href="<?= base_url('export') ?>">Export Applicant Data</a>
                    <a class="export-a" href="<?= base_url('export-photos') ?>">Export Applicant Pictures</a>
                    <!-- <a class="export-a" href="<?= base_url('export-emirates-files') ?>">Export Emirates ID Files</a> -->
                    <a href="<?= base_url('admin-logout') ?>">Logout</a>
                </div>
            </div>
            <a href="<?= base_url('registrants') ?>" class="importbtn">Registrants</a>
            <a href="<?= base_url('dashboard') ?>" class="importbtn">Dashboard</a>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Import Applicant Details</h2>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-6 m-auto">
                    <form method="post" id="import_form" enctype="multipart/form-data">
                        <div class="file-upload-wrapper" data-text="Select the file to upload">
                            <!-- <p><label>Select Excel File</label> -->
                            <input type="file" name="file" id="file" class="file-upload-field" required accept=".csv" />
                            <!-- </p> -->
                        </div>
                        <br />
...
<script>
    $(document).ready(function() {
        ...
        $('#import_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "<?= base_url('import-applicants'); ?>",
                dataType: 'json',
                method: "POST",
