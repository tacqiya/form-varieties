    ...
    <div class="wrapper content">
        <form method="POST" action="" id="submission-form">
            ...
            <div class="field single">
                <label for="reg_email">Registered email at KU Alumni Platform: <span class="required">*</span></label>
                <input type="email" class="r_email" name="reg_email" required autocomplete="off" value="<?= ($registered_data && $registered_data->reg_email) ? $registered_data->reg_email : ''; ?>">
            </div>
            ...
            <div class="field insert clear">
                <div class="preview-img-blk">
                    <img class="preview preview_profile" src="<?= ($registered_data && $registered_data->profile_photo) ? base_url() . 'uploads/' . $registered_data->profile_photo : ''; ?>" />
                </div>
                <div class="drop-blk">
                    <div class="img-upload">
                        <span class="text"><b>Choose an image</b> or drag & drop here</span>
                        <input type="file" class="photo" id="photo" name="profile_photo" accept="image/jpg, image/png, image/gif, image/jpeg" <?= ($registered_data && $registered_data->profile_photo) ? '' : 'required'; ?>>
            ...
            <div class="field double clear">
                <div class="blk clear">
                    ...
                    <select name="degree" class="degree" required>
                        ...
                        <option value="Bachelor" <?= ($registered_data && ($registered_data->degree == 'Bachelor')) ? 'selected' : ''; ?>>Bachelor</option>
                        <option value="Master" <?= ($registered_data && ($registered_data->degree == 'Master')) ? 'selected' : ''; ?>>Master</option>
                        <option value="PhD" <?= ($registered_data && ($registered_data->degree == 'PhD')) ? 'selected' : ''; ?>>PhD</option>
                    </select>
                </div>
                <div class="blk clear">
            ...
            <div class="field double clear">
                ...
                <div class="blk clear">
                    <label for="g_insti">Graduation institution: <span class="required">*</span></label> <span style="color: #7f7f7d;">(Add KU Degrees only)</span>
                    <input type="text" name="g_insti" class="g_insti" required autocomplete="off" value="<?= ($registered_data && $registered_data->g_insti) ? $registered_data->g_insti : ''; ?>">
                </div>
            </div>
            ...
            <div class="field double clear">
                <div class="blk clear">
                    ...
                    <input type="hidden" name="real_phone" class="real_phone" required autocomplete="off" value="<?= ($user_details && $user_details->mobile) ? $user_details->mobile : ''; ?>">
                </div>
                <div class="blk clear">
            ...
            <div class="field single clear">
                <label for="linkd_in">LinkedIn Account : <span class="required">*</span> <span>(please type your username or paste your account URL here)</span></label>
                <input type="text" class="linkedin" name="linkd_in" required autocomplete="off" value="<?= ($registered_data && $registered_data->linkd_in) ? $registered_data->linkd_in : ''; ?>">
            </div>
            ...
            if (form.elements[i].value === '' && form.elements[i].hasAttribute('required')) {
                if (!form.elements[i].hasAttribute('disabled')) {
                    if (form.elements[i].name == 'profile_photo') {
                        var cont = '<strong>Profile picture</strong> is required';
                    } else {
                        var cont = '<strong>' + $('label[for="' + form.elements[i].name + '"]').text().replace('*', '') + '</strong> is required';
                    }
                    $.dialog({
                        type: 'orange',
                        title: 'Warning',
