...
<head>
    ...
    <!--styles-->
    <link href="<?= base_url() ?>assets/scss/reset_css.css?v=1.0" type="text/css" rel="stylesheet" />
    <link href="<?= base_url() ?>assets/scss/style.css?v=2.0" type="text/css" rel="stylesheet" />
    <link href="<?= base_url() ?>assets/scss/inside.css?v=1.0" type="text/css" rel="stylesheet" />
    <link href="<?= base_url() ?>assets/scss/responsive/style-responsive.css?v=1.0" type="text/css" rel="stylesheet" />
