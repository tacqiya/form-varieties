...
!(function(t, e) {
    ...
    function M(a, s) {
        for (
            var t = arguments.length, n = new Array(2 < t ? t - 2 : 0), e = 2; e < t; e++
        )
            n[e - 2] = arguments[e];
        return function() {
    ...
    var S,
        ...
        N = {
            ...
            getMonthName: function(t, e) {
                var i = this.options,
                    ...
                    i = i.months;
                return (
                    k.isNumeric(t) ? (t = Number(t)) : x(e) && (e = t), !0 === e && (i = a),
        ...
        j = {
            ...
            globalClick: function(t) {
                for (
                    var e = t.target, i = this.element, a = this.$trigger[0], s = !0; e !== document;
        ...
        q = {
            ...
            renderYears: function() {
                for (
                    ...
                    var u = new Date(n + d, 1, 1),
                        p = !1;
                    e && ((p = u.getFullYear() < e.getFullYear()), -5 === d && (l = p)), !p &&
                        i &&
                        ((p = u.getFullYear() > i.getFullYear()), 6 === d && (c = p)), !p && s && (p = !1 === s.call(this.$element, u, "year"));
                    var f = n + d === h,
                ...
                for (
                    ...
                    e &&
                        (m =
                            ...
                            y.getMonth() < e.getMonth()), !m &&
                        i &&
                        (m =
                            (f = y.getFullYear() === i.getFullYear()) &&
                            y.getMonth() > i.getMonth()), !m && r && (m = !1 === r.call(this.$element, y, "month"));
                    var v = h === c && g === d,
            ...
            renderDays: function() {
                ...
                for (
                    ...
                    var $ = new Date(D, b, P),
                        x = !1;
                    a && (x = $.getTime() < a.getTime()), !x && o && (x = !1 === o.call(e, $, "day")),
                        k.push(
                            this.createItem({
                                disabled: x,
                ...
                for (s && (c = r.getTime() >= s.getTime()), P = 1; P <= C; P += 1) {
                    var V = new Date(M, Y, P),
                        T = M === m && Y === v && P === w,
                        I = !1;
                    s && (I = V.getTime() > s.getTime()), !I && o && (I = !1 === o.call(e, V, "day")),
                        F.push(
                            this.createItem({
                                disabled: I,
                                picked: T,
    ...
    k.extend && k.extend(J.prototype, q, j, N),
        ...
        ((S = k.fn.datepicker),
            (k.fn.datepicker = function(r) {
                for (
                    var h, t = arguments.length, o = new Array(1 < t ? t - 1 : 0), e = 1; e < t; e++
                )
                    o[e - 1] = arguments[e];
                return (
